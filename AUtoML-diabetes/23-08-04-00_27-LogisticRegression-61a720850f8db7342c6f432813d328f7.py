...
# MAGIC This is an auto-generated notebook. To reproduce these results, attach this notebook to the **Sohail Hosseini's Cluster** cluster and rerun it.
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/557053454446975/s?orderByKey=metrics.%60val_f1_score%60&orderByAsc=false)
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/557053454446975/s?orderByKey=metrics.%60val_f1_score%60&orderByAsc=false)
